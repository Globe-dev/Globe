...
function openIssuesPage() {
  ipcRenderer.send("tabManager-addTab", "https://github.com/Globe-dev/Globe/issues", true);
}
...
function openPatreonPage() {
  ipcRenderer.send("tabManager-addTab", "https://www.patreon.com/globebrowser", true);
}

function openDeveloperPage() {
  ipcRenderer.send("tabManager-addTab", "https://github.com/Globe-dev/Globe", true);
}
...
function openReleasesPage() {
  ipcRenderer.send("tabManager-addTab", "https://github.com/Globe-dev/Globe/releases", true);
}
...
function openLicensePage() {
  ipcRenderer.send("tabManager-addTab", "https://github.com/Globe-dev/Globe/blob/main/LICENSE", true);
}
